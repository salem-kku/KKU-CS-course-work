...
graph BT;
    ...
    %% Seventh Year - Capstone & Advanced Topics
    CP --> PROJ(4381CCS-3 Graduation Project);
    ...
    %% Sixth Year - Parallel & Algorithms
    ...
    OOP --> GD(3371CCS-3 Game Design & Development);
    Free(Free Course);

    %% Fourth Year - Core System Topics
    DS(2431CCS-4 Data Structures & Algorithms) --> OOP;
    ...
    %% Third Year - Programming & Architecture
    ...
    OOP(2413CCS-4 Object-Oriented Programming) --> IP(1312CCS-3 Introduction to Programming);
    IP --> PS;
    ...
    %% First Year - Foundational Courses (No Prerequisites)
