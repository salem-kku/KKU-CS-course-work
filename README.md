...
flowchart LR
  ...
  %% === Main CS Curriculum Block ===
  subgraph CS_Curriculum
    direction TB
    
    %% === First Semester ===
    subgraph Sem1[Semester 1]
      direction RL
      PS(1311CCS-3 Problem Solving & Programming) --> IP(1312CCS-3 Introduction to Programming)
    ...
    subgraph Sem2[Semester 2]
      direction BT
      IP --> OOP(2413CCS-4 Object-Oriented Programming)
    ...
    subgraph Sem3[Semester 3]
      direction RL
      OOP --> DS(2431CCS-4 Data Structures & Algorithms)
    ...
    subgraph Sem4[Semester 4]
      ...
      OS(2323CCS-3 Operating Systems) --> PD(3325CCS-3 Parallel & Distributed Computing)
    ...
    subgraph Sem6[Semester 6]
      direction BT
      SPM(3343CCS-3 Software Project Management) --> PROJ(4381CCS-3 Graduation Project)
